...
public class GameOverState extends GameState {
    ...
    private ImageIcon gameOverBackgroundImageIcon;
    private Image gameOverBackgroundImage;
    
    private Sounds gameOverMusic;
    
    private String[] options = {"Start New Game", "Back To Main Menu", "Quit"};
    ...
    public GameOverState(GameStateManager gameStateManager) {
        ...
        gameOverBackgroundImageIcon = new ImageIcon("src/mindquest/images/gameover_pyramid_background.png");
        gameOverBackgroundImage = gameOverBackgroundImageIcon.getImage();
        
        gameOverMusic = new Sounds("GameOverMusic");
        gameOverMusic.loop();
